...
public class LocaleManager {
    ...
    public static void fillSession(HttpSession session) {
        try {
            ...
            session.setAttribute("gym", new String((LocaleManager.getProperty("label.gym").getBytes("ISO-8859-1")), "Cp1251"));
            session.setAttribute("descriptionAboutShop", new String((LocaleManager.getProperty("label.shopDescription").getBytes("ISO-8859-1")), "Cp1251"));
